...
public class HangHoaJFrame extends javax.swing.JFrame {
    ...
    public HangHoaJFrame(JTextField x) {
        this();
        this.x = x;
    }
    ...
    void fillComboBox() {
        DefaultComboBoxModel model = (DefaultComboBoxModel) cbxMaLoaiHang.getModel();
    ...
    void fillComboBox1() {
        DefaultComboBoxModel model = (DefaultComboBoxModel) cbxTenLoaiHang.getModel();
        model.removeAllElements();
        try {
            List<LoaiHang> list = dao1.select();
            for (LoaiHang lh : list) {
    ...
    void setModel(HangHoa model) {
        ...
        cbxMaLoaiHang.setSelectedItem(model.getMaLoai());
...
//        cbxTe.setSelectedItem(dao.findById(model.getTenHH()));
        ...
        cbxDonVi.setSelectedItem(model.getDonVi());
    ...
    LoaiHang getModel1() {
        ...
        model.setMaLoai(String.valueOf(cbxMaLoaiHang.getSelectedItem()));
        model.setTenLoai(String.valueOf(cbxTenLoaiHang.getSelectedItem()));
        return model;
    }

    void setModel1(LoaiHang model) {
        cbxMaLoaiHang.setSelectedItem(String.valueOf(model.getMaLoai()));
        cbxTenLoaiHang.setSelectedItem(String.valueOf(model.getTenLoai()));
    }
    ...
    HangHoa getModel() {
        ...
        model.setDonVi((String) cbxDonVi.getSelectedItem());
    ...
    void edit1() {
        try {
            String makh = String.valueOf(cbxMaLoaiHang.getSelectedItem());
    ...
    public boolean Check() {
        ...
        try {
            ...
            if (txtTenHH.getText().length() == 0) {
                DialogHelper.alert(this, "Tên Hàng Hóa KHÔNG được để trống!");
                txtTenHH.requestFocus();
                return false;
            } else if (!txtTenHH.getText().matches("[a-zA-Z]+")) {
                DialogHelper.alert(this, "Tên Hàng Hóa chỉ chứa alphabet và ký tự trắng!");
                txtTenHH.requestFocus();
                return false;
            }
    ...
    private void initComponents() {
        ...
        cbxTenLoaiHang = new javax.swing.JComboBox<>();
        cbxMaLoaiHang = new javax.swing.JComboBox<>();
        ...
        cbxDonVi.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        cbxDonVi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bộ" }));
        ...
        cbxTenLoaiHang.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        cbxTenLoaiHang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxTenLoaiHangActionPerformed(evt);
            }
        });

        cbxMaLoaiHang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxMaLoaiHangActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(pnlContentLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlContentLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cbxMaLoaiHang, 0, 486, Short.MAX_VALUE)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(cbxTenLoaiHang, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlContentLayout.createSequentialGroup()
                                                ...
                                                .addGap(35, 35, 35)
                                                .addComponent(cbxDonVi, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlContentLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(cbxMaLoaiHang, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lblTenLoaiHang)
                            .addComponent(cbxTenLoaiHang, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lblDonGia)
        ...
        jPanel1.add(pnlContent, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 840, 610));

        pnlLoaiHang.setBackground(new java.awt.Color(255, 255, 255));
        pnlLoaiHang.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Loại Hàng", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 16), new java.awt.Color(0, 51, 255))); // NOI18N

        lblMaLoai.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        btnInsert.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons_save.png"))); // NOI18N
        ...
        btnXoa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons8_delete_bin_32px.png"))); // NOI18N
        ...
        pnlLoaiHangLayout.setHorizontalGroup(
            ...
            .addGroup(pnlLoaiHangLayout.createSequentialGroup()
                ...
                .addGroup(pnlLoaiHangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtTenLoai, javax.swing.GroupLayout.PREFERRED_SIZE, 483, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1.add(pnlLoaiHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 840, 130));
    ...
    private void btnLastActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLastActionPerformed
        // TODO add your handling code here:
        this.index = tblGridViewHH.getRowCount() - 1;
        this.Edit();
    ...
    private void cbxMaLoaiHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxMaLoaiHangActionPerformed
        // TODO add your handling code here:
//        this.SelectComboBox();
    }//GEN-LAST:event_cbxMaLoaiHangActionPerformed

    private void btnXuatExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatExcelActionPerformed
        // TODO add your handling code here:
        try {
            XSSFWorkbook workbook = new XSSFWorkbook();
            XSSFSheet spreadsheet = workbook.createSheet("Hàng Hóa");
            ...
            List<HangHoa> listItem = hh.select();
            for (int i = 0; i < listItem.size(); i++) {
                ...
                row.createCell(1).setCellValue(nv.getMaHH());
                row.createCell(2).setCellValue(nv.getMaLoai());
                row.createCell(3).setCellValue(nv.getTenHH());
                row.createCell(4).setCellValue(nv.getDonGia());
                row.createCell(5).setCellValue(nv.getDonVi());
                row.createCell(6).setCellValue(nv.getGhiChu());
            }
            FileOutputStream out = new FileOutputStream(new File("D:/HangHoa.xlsx"));
            workbook.write(out);
    ...
    private void cbxTenLoaiHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxTenLoaiHangActionPerformed
        // TODO add your handling code here:
        // SelectComboBox();
    }//GEN-LAST:event_cbxTenLoaiHangActionPerformed
    ...
    private javax.swing.JComboBox<LoaiHang> cbxMaLoaiHang;
    private javax.swing.JComboBox<String> cbxTenLoaiHang;
